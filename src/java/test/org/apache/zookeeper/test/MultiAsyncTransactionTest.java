...
public class MultiAsyncTransactionTest extends ClientBase {
    ...
    /**
     * ZOOKEEPER-1624: PendingChanges of create sequential node request didn't get rollbacked correctly when multi-op failed. This cause create sequential node request in subsequent multi-op to failed
     * because sequential node name generation is incorrect.
     *
     * The check is to make sure that each request in multi-op failed with the correct reason.
     */
    @Test
