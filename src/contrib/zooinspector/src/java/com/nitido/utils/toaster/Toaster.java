/**
 * This java file is copyright by Daniele Piras ("danielepiras80", no email known) released under the Apache Software License 2.0. It has been downloaded in december 2009 from the CVS web interface of
 * the sourceforge project http://sourceforge.net/projects/jtoaster/ . The web interface to CVS is not available anymore on sourceforge.
 *
 *
 * Java Toaster is a java utility class for your swing applications that show an animate box coming from the bottom of your screen with a notification message and/or an associated image (like msn
 ...
 *
 * // Show a simple toaster toasterManager.showToaster( new ImageIcon( "mylogo.gif" ), "A simple toaster with an image" ); } }
 */
